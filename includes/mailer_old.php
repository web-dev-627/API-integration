...
try {
    ...
    $mail->Host = 'autobutler.no';  // Specify main and backup SMTP servers
    $mail->SMTPAuth = true;                               // Enable SMTP authentication
    $mail->Username = 'dekkhotell@autobutler.no';                 // SMTP username
	...
	*/
    ...
    //Recipients
    $mail->setFrom('dekkhotell@autobutler.no', 'Dekkhotell - Autobutler');
